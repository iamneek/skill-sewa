...
<head>
    ...
    <title>Skill Sewa | Edit Skill</title>
...
<main>
    ...
    <section class="form-shell">
        <div class="container">
            <form class="skill-form" action="${ctx}/user/edit-skill" method="post">
                ...
                <input id="title" name="title" type="text" maxlength="150" value="${formTitle}" required />
                ...
                <textarea id="description" name="description" maxlength="2000" rows="8">${formDescription}</textarea>

                <label for="pricePer10">Price per 10 minutes (USD)</label>
                <input id="pricePer10" name="pricePer10" type="number" min="0.01" max="9999" step="0.01" value="${formPrice}" required />
